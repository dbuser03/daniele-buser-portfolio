...
export default function WorkWord({
  ...
  return (
    <motion.button
      type="button"
      className="relative flex items-center overflow-visible border-none bg-transparent p-0 text-left text-3xl font-medium sm:text-4xl md:text-5xl xl:text-6xl 2xl:text-7xl focus-visible:outline focus-visible:outline-2 focus-visible:outline-(--accent) focus-visible:outline-offset-4 focus-visible:rounded-sm"
