...
export const PROJECTS: Project[] = [
  {
    ...
    role: "Creative Development & Design Engineering",
    websiteUrl: "https://github.com/dbuser03", // placeholder or real link
    githubUrl: "https://github.com/dbuser03",
    brandingColors: ["#0A0A0A", "#262626", "#737373", "#E5E5E5", "#F7F7F7"],
    brandingFontName: "PP Neue Montreal",
    brandingFontFamily: "Sans-Serif / Variable",
  },
];
